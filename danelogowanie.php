    ...
    else
    {
        ...
        mysqli_real_escape_string($polaczenie,$haslo2))))
        {
            ...
            if($ilu_userow>0)
            {
                ...
                $polaczenie->query ("UPDATE klienci SET `klucz_logowania` = '$hash' where login='$login'");
                ...
                $_SESSION['blad'] = '<span style="color:red"></br>Podano nieprawidłowy login lub hasło, spróbuj ponownie.</span>';
                header('Location: logowanie.php'); 
            }  
        }
        $polaczenie->close();
